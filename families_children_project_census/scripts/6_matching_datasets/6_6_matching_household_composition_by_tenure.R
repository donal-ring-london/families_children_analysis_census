...
## This script will be different from the others. I already have this matched at from 2011 to 2021 at LSOA level, from a different data processing project. 
## So I need to read that dataset in, aggregate the geographies to local authority, match categories with 2001, and reformat it to the same sort of dataset as the other matched datasets for this project.
...
ten_hhcomp_21_11 <- ten_hhcomp_21_11[, .(value_21 = sum(value_21), value_11 = sum(value_11)),
  ...
  ### only keeping families with dependent children

ten_hhcomp_21_11 <- ten_hhcomp_21_11[dependent_children == "Household with dependent children",]
...
keep <- c("With dependent children")

st053_01 <- st053_01[c_hhchuk11_name == "With dependent children",]
...
fwrite(x = rm132_21_LC4412_11_st053_01,
       file = "data/category_matched_at_la/rm132_21_LC4412_11_st053_01.csv")



## There is some issue with the 2001 data, particularly for Private Rented. It is far bigger than it should be. By about 2 times. 
## After a lot of careful checking, I can't figure out what the issue is. So we can't use the 2001 data for this file. 
