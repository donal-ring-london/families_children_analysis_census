...
## matching household composition by ethnic group of hrp, but only for couples or lone families without children
...
## 3. matching the number of children in each household across censuses. Only one final category - "Couple/lone parent with no dependent children"
...
mapping_01 <- data.table(
  cat_01 = c("One family : Married couple family households : No children", "One family : Married couple family households : All children non-dependent",
             "One family : Cohabiting couple family households : No children", "One family : Cohabiting couple family households : All children non-dependent",
             "One family : Lone parent households : All children non-dependent"),
  cat_common = c("Couple/lone parent with no dependent children", "Couple/lone parent with no dependent children",
                 "Couple/lone parent with no dependent children", "Couple/lone parent with no dependent children",
                 "Couple/lone parent with no dependent children")
)
...
mapping_11 <- data.table(
  cat_11 = c("One family only: Married or same-sex civil partnership couple: No children", "One family only: Married or same-sex civil partnership couple: All children non-dependent",
             "One family only: Cohabiting couple: No children", "One family only: Cohabiting couple: All children non-dependent", 
...
mapping_21 <- data.table(
  cat_21 = c("Single family household: Married or civil partnership couple: No children", "Single family household: Married or civil partnership couple: All children non-dependent",
             "Single family household: Cohabiting couple family: No children", "Single family household: Cohabiting couple family: All children non-dependent",
...
fwrite(x = ftb_hhcomp_ethgroup_21_dc1201_11_st106_01,
       file = "data/category_matched_at_la/ftb_hhcomp_ethgroup_21_dc1201_11_st106_01_without.csv")
